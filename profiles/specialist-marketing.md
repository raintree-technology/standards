...
- The task contract lists every active channel, jurisdiction, platform, partner, asset, identity, data flow, claim, incentive, and authority boundary.
- Each activated specialist standard has its stated launch, measurement, complaint, pause, correction, and retirement evidence.
- Current platform terms and jurisdiction-specific requirements are pinned in the work record and reviewed by a qualified owner when applicable.
- Costs and outcomes reconcile with authoritative systems; attribution, overlap, modeled data, fraud, and uncertainty are explicit.
- A final journey inspection covers rendered disclosure, choice, accessibility, destination truth, suppression, offboarding, and stale-copy removal.
- Unresolved limitations and exceptions identify owner, scope, risk, compensating control, expiry, and follow-up date.
