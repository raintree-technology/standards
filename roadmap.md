...
- Security: authentication, authorization, secrets, input handling, supply chain, threat modeling
- Privacy: collection, consent, retention, deletion, data subject requests
...
- AI: model selection, evaluation, prompt handling, data boundaries, fallback behavior
